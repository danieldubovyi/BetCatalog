...
import BankAccountUpdate from "./BankAccounts/BankAccountUpdate";
import Persons from "./Persons/Persons";
import PersonUpdate from "./Persons/PersonUpdate";
      ...
      <Router>
        ...
        <div className='Content'>
          <Routes>
            ...
            <Route path="/bankAccounts/:id/update" element={<BankAccountUpdate />} />
            <Route path="/persons" element={<Persons />} />
            <Route path="/persons/create" element={<PersonCreate />} />
            <Route path="/persons/:id" element={<PersonDetails />} />
            <Route path="/persons/:id/update" element={<PersonUpdate />} />
